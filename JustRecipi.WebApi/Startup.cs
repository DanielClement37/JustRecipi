...
using JustRecipi.Services.Services;
...
namespace JustRecipi.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "JustRecipi.WebApi", Version = "v1"});
            });
            
            services.AddDbContext<JustRecipiDbContext>(opts =>
            {
                opts.EnableDetailedErrors();
                opts.UseNpgsql(Configuration.GetConnectionString("justrecipi.dev"));
            });
            
            services.AddIdentity<User, IdentityRole>()
                .AddEntityFrameworkStores<JustRecipiDbContext>()
